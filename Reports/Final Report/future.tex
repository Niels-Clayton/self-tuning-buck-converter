...
As discussed in \Cref{S:system_design}, there are 3 main segments of work in this project. The first segment of work was the PWM generator, which has been outlined in \Cref{S:pwm_gen_design} and has already been completed. The next two section were the specification and selection of the required sensing elements, and then the implementation of the control system that will make this project functional.\\
